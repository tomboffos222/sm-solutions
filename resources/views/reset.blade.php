...
<div class="kuylover">
    ...
    <section class="container">
        ...
        <div class="login">
            ...
            @endif
            <div class="title-text"><h1>Забыли пароль</h1></div>

            <form method="get" action="{{route('SendPass')}}" class="forma">
                <div class="">
                    <input type="text" name="mail" class="form-control"  placeholder="Ваш mail" class="zapol">
